...
## **必看内容** 如遇到操作界面没有反应的情况，发生/cancel命令退出当前操作即可。
...
### 6. 骗子，你不是说自动化一键安装吗，为什么我这里报错--缺少依赖: git，请先安装！

- 大哥，这是你服务器基础依赖需要自己安装。一键脚本主打一个安全省心，并不会额外安装其他东西。
...
### 1.管理员使用/menu命令即可为bot自动添加下拉菜单

### 2.优化管理员菜单命令逻辑

### 3.定时任务功能已经完善可正常使用

### 4.添加用户区分（普通、白名单、黑名单）用户

### 5.添加bot发送信息30秒撤回，让界面看起来清爽
